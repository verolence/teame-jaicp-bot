...
theme: /
    ...
    state: Start
        ...
        state: Onboarding
            ...
            a: Когда захочешь записать эти благодарности, жми "Сдать задание", либо можешь использовать команду /finishtask
            script: 
                $session.currentTask = "Дневник благодарности"
            buttons: 
                "Сдать задание"
                
            state: CatchAll || noContext=true
                q: *
                a: Нажми на кнопку "Сдать задание", затем отправь мне свой ответ.
                buttons: 
                    "Сдать задание"
                go: ..
